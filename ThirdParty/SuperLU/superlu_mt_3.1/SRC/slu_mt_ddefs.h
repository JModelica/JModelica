...
/* ----------------
   Driver routines
   ---------------*/
extern void pdgssv(int_t, SuperMatrix *, int_t *, int_t *, SuperMatrix *,
                   SuperMatrix *, SuperMatrix *, int_t *);
extern void pdgssvx(int_t, superlumt_options_t *, SuperMatrix *, int_t *,
                    int_t *, equed_t *, double *, double *, SuperMatrix *,
                    SuperMatrix *, SuperMatrix *, SuperMatrix *, double *,
                    double *, double *, double *, superlu_memusage_t *,
                    int_t *);

/* ---------------
   Driver related
   ---------------*/
extern void dgsequ(SuperMatrix *, double *, double *, double *, double *,
                   double *, int_t *);
extern void dlaqgs(SuperMatrix *, double *, double *, double, double, double,
                   equed_t *);
extern void dgscon(char *, SuperMatrix *, SuperMatrix *, double, double *,
                   int_t *);
extern double dPivotGrowth(int_t, SuperMatrix *, int_t *, SuperMatrix *,
                           SuperMatrix *);
...
extern int_t sp_dtrsv(char *, char *, char *, SuperMatrix *, SuperMatrix *,
                      double *, int_t *);
extern int_t sp_dgemv(char *, double, SuperMatrix *, double *, int_t, double,
                      double *, int_t);
extern int_t sp_dgemm(char *, int_t, int_t, int_t, double, SuperMatrix *,
                      double *, int_t, double, double *, int_t);

extern int_t sp_symetree(int_t *acolst, int_t *acolend, int_t *arow, int_t n,
                         int_t *parent);

extern int_t cholnzcnt(int_t neqns, int_t *xadj, int_t *adjncy, int_t *perm,
                       int_t *invp, int_t *etpar, int_t *colcnt, int_t *nlnz,
                       int_t *part_super_L);

/* ----------------------
   Factorization related
   ----------------------*/
extern void pxgstrf_scheduler(const int_t, const int_t, const int_t *, int_t *,
...
extern void PartDomains(const int_t, const float, SuperMatrix *, int_t *,
                        int_t *);

extern void dCreate_CompCol_Matrix(SuperMatrix *, int_t, int_t, int_t, double *,
                                   int_t *, int_t *, Stype_t, Dtype_t, Mtype_t);
void dCreate_CompCol_Permuted(SuperMatrix *, int_t, int_t, int_t, double *,
                              int_t *, int_t *, int_t *, Stype_t, Dtype_t,
                              Mtype_t);
extern void dCopy_CompCol_Matrix(SuperMatrix *, SuperMatrix *);
extern void dCreate_Dense_Matrix(SuperMatrix *, int_t, int_t, double *, int_t,
                                 Stype_t, Dtype_t, Mtype_t);
extern void dCreate_SuperNode_Matrix(SuperMatrix *, int_t, int_t, int_t,
                                     double *, int_t *, int_t *, int_t *,
                                     int_t *, int_t *, Stype_t, Dtype_t,
                                     Mtype_t);
extern void dCreate_SuperNode_Permuted(SuperMatrix *, int_t, int_t, int_t,
                                       double *, int_t *, int_t *, int_t *,
                                       int_t *, int_t *, int_t *, int_t *,
                                       int_t *, Stype_t, Dtype_t, Mtype_t);
extern void dCopy_Dense_Matrix(int_t, int_t, double *, int_t, double *, int_t);
...
extern void StatAlloc(const int_t, const int_t, const int_t, const int_t,
                      Gstat_t *);
...
extern int_t qrnzcnt(int_t, int_t, int_t *, int_t *, int_t *, int_t *, int_t *,
                     int_t *, int_t *, int_t *, int_t *, int_t *);
extern int_t DynamicSetMap(const int_t, const int_t, const int_t,
                           pxgstrf_shared_t *);
extern void pdgstrf(superlumt_options_t *, SuperMatrix *, int_t *,
                    SuperMatrix *, SuperMatrix *, Gstat_t *, int_t *);
extern void pdgstrf_init(int_t, fact_t, trans_t, yes_no_t, int_t, int_t, double,
                         yes_no_t, double, int_t *, int_t *, void *, int_t,
                         SuperMatrix *, SuperMatrix *, superlumt_options_t *,
                         Gstat_t *);
extern pdgstrf_threadarg_t *pdgstrf_thread_init(SuperMatrix *, SuperMatrix *,
                                                SuperMatrix *,
                                                superlumt_options_t *,
                                                pxgstrf_shared_t *, Gstat_t *,
                                                int_t *);
extern void pdgstrf_thread_finalize(pdgstrf_threadarg_t *, pxgstrf_shared_t *,
                                    SuperMatrix *, int_t *, SuperMatrix *,
                                    SuperMatrix *);
...
extern void pdgstrf_relax_snode(const int_t, superlumt_options_t *,
                                pxgstrf_relax_t *);
extern void pxgstrf_relax_snode(const int_t n,
                                superlumt_options_t *superlumt_options,
                                pxgstrf_relax_t *pxgstrf_relax);
extern int_t pdgstrf_factor_snode(const int_t, const int_t, SuperMatrix *,
                                  const double, yes_no_t *, int_t *, int_t *,
                                  int_t *, int_t *, int_t *, int_t *, double *,
                                  double *, pxgstrf_shared_t *, int_t *);
extern void pxgstrf_mark_busy_descends(int_t, int_t, int_t *,
                                       pxgstrf_shared_t *, int_t *, int_t *);
extern int_t pdgstrf_snode_dfs(const int_t, const int_t, const int_t,
                               const int_t *, const int_t *, const int_t *,
                               int_t *, int_t *, int_t *, pxgstrf_shared_t *);
extern int_t pdgstrf_snode_bmod(const int_t, const int_t, const int_t,
                                const int_t, double *, double *, GlobalLU_t *,
                                Gstat_t *);
extern void pdgstrf_panel_dfs(const int_t, const int_t, const int_t,
                              const int_t, SuperMatrix *, int_t *, int_t *,
                              int_t *, int_t *, int_t *, int_t *, int_t *,
                              int_t *, int_t *, int_t *, int_t *, int_t *,
                              int_t *, double *, GlobalLU_t *);
extern void pdgstrf_panel_bmod(const int_t, const int_t, const int_t,
                               const int_t, const int_t, int_t *, int_t *,
                               int_t *, int_t *, int_t *, int_t *, int_t *,
                               int_t *, double *, double *, pxgstrf_shared_t *);
...
extern void pdgstrf_bmod2D(const int_t, const int_t, const int_t, const int_t,
                           ...
                           int_t *, int_t *, int_t *, int_t *, double *,
                           double *, GlobalLU_t *, Gstat_t *);
extern void pdgstrf_bmod1D_mv2(const int_t, const int_t, const int_t,
                               const int_t, const int_t, const int_t,
                               const int_t, int_t, int_t, int_t *, int_t *,
                               int_t *, int_t *, double *, double *,
                               GlobalLU_t *, Gstat_t *);
extern void pdgstrf_bmod2D_mv2(const int_t, const int_t, const int_t,
                               const int_t, const int_t, const int_t,
                               const int_t, int_t, int_t, int_t *, int_t *,
                               int_t *, int_t *, double *, double *,
                               GlobalLU_t *, Gstat_t *);
...
extern int_t pdgstrf_column_dfs(const int_t, const int_t, const int_t,
                                const int_t, int_t *, int_t *, int_t *, int_t,
                                int_t *, int_t *, int_t *, int_t *, int_t *,
                                int_t *, int_t *, int_t *, pxgstrf_shared_t *);
extern int_t pdgstrf_column_bmod(const int_t, const int_t, const int_t,
                                 const int_t, int_t *, int_t *, double *,
                                 double *, pxgstrf_shared_t *, Gstat_t *);
extern int_t pdgstrf_pivotL(const int_t, const int_t, const double, yes_no_t *,
                            int_t *, int_t *, int_t *, int_t *, GlobalLU_t *,
                            Gstat_t *);
extern int_t pdgstrf_copy_to_ucol(const int_t, const int_t, const int_t,
                                  const int_t *, const int_t *, const int_t *,
                                  double *, pxgstrf_shared_t *);
...
extern int dtrsv_(char *, char *, char *, int *, double *, int *, double *,
                  int *);
extern int dgemv_(char *, int *, int *, double *, double *, int *, double *,
                  int *, double *, double *, int *);

/* ---------------
   Memory related
   ---------------*/
extern float pdgstrf_MemInit(int_t, int_t, superlumt_options_t *, SuperMatrix *,
                             SuperMatrix *, GlobalLU_t *);
...
extern void pxgstrf_SetIWork(int_t, int_t, int_t *, int_t **, int_t **,
                             int_t **, int_t **, int_t **, int_t **, int_t **);
...
extern void dPrintPerf(SuperMatrix *, SuperMatrix *, superlu_memusage_t *,
                       double, double, double *, double *, char *, Gstat_t *);
extern void dCompRow_to_CompCol(int_t m, int_t n, int_t nnz, double *a,
                                int_t *colind, int_t *rowptr, double **at,
                                int_t **rowind, int_t **colptr);

/* -----------------------
   Routines for debugging
   -----------------------*/
extern void print_lu_col(int_t, char *, int_t, int_t, int_t, int_t *,
                         GlobalLU_t *);
