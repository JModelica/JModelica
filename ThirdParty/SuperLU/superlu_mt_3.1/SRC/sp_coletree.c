...
static int_t make_link(int_t s, int_t t, int_t *pp) {
  pp[s] = t;
  return t;
}
...
static void finalize_disjoint_sets(int_t *pp) { SUPERLU_FREE(pp); }
...
static
     ...
     */
    void
    etdfs(int_t v, int_t first_kid[], int_t next_kid[], int_t post[],
          int_t *postnum) {
  int_t w;
...
static
     ...
     */
    void
    nr_etdfs(int_t n, int_t *parent, int_t *first_kid, int_t *next_kid,
 ...
 */
int_t sp_symetree(int_t *acolst,
